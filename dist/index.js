...
console.log('ciao'); // const Server = require('colyseus');
// const http = require('http');
// const express = require('express');
// const path = require('path');
// const basicAuth = require('express-basic-auth');
// const monitor = require('@colyseus/monitor');
// const AgarIOCostanzo = require('./utils/AgarIOCostanzo.js');
// const { PORT, ENDPOINT } = AgarIOCostanzo;
// console.log('ciao');
// const app = express();
// const gameServer = new Server({ server: http.createServer(app) });
// // gameServer.register('arena', undefined);
